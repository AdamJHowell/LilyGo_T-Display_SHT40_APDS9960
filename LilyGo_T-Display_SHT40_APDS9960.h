...
const unsigned int mqttConnectionTimeout = 5000;						  // The maximum amount of time to wait for a MQTT connection before considering the attempt to have failed.
const unsigned int JSON_DOC_SIZE = 1024;									  // The ArduinoJson document size, and size of some buffers.
...
const char *VOLTAGE_TOPIC = "T-Display-S3/milliVolts";				  // The topic used to publish the device voltage.
...
const char *WIFI_COUNT_TOPIC = "T-Display-S3/wifiCount";				  // The topic used to publish the number of times Wi-Fi has (re)connected.
const char *WIFI_COOLDOWN_TOPIC = "T-Display-S3/wifiCooldown";		  // The topic used to publish the "cooldown" time between Wi-Fi connections.
const char *MQTT_COUNT_TOPIC = "T-Display-S3/mqttCount";				  // The topic used to publish the number of times MQTT has (re)connected.
const char *MQTT_COOLDOWN_TOPIC = "T-Display-S3/mqttCooldown";		  // The topic used to publish the "cooldown" time between MQTT connections.
...
const char *LIGHT_RED_TOPIC = "T-Display-S3/apds9960/redValue";	  // The topic used to publish the measured red light.
const char *LIGHT_GREEN_TOPIC = "T-Display-S3/apds9960/greenValue"; // The topic used to publish the measured green light.
const char *LIGHT_BLUE_TOPIC = "T-Display-S3/apds9960/blueValue";	  // The topic used to publish the measured blue light.
const char *LIGHT_CLEAR_TOPIC = "T-Display-S3/apds9960/clearValue"; // The topic used to publish the measured clear light.
